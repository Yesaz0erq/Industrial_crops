    ...
    public static List<Section> combinedSections() {
        return List.of(
                section("itemGroup.industrialcrops.section.industrial_crops",
                        ...
                        crop(ModItems.PRISM_POD_SEEDS), crop(ModItems.BAGGED_PRISM_POD_SEEDS), crop(ModItems.PRISM_POD),
                        crop(ModItems.EMBERCOIL_SEEDS), crop(ModItems.BAGGED_EMBERCOIL_SEEDS), crop(ModItems.EMBERCOIL),
                        crop(ModItems.STARBLOOM_SEEDS), crop(ModItems.BAGGED_STARBLOOM_SEEDS), crop(ModItems.STARBLOOM),
                        crop(ModItems.NEONBULB_SEEDS), crop(ModItems.BAGGED_NEONBULB_SEEDS), crop(ModItems.NEONBULB),
                        crop(ModItems.FLUXSTALK_SEEDS), crop(ModItems.BAGGED_FLUXSTALK_SEEDS), crop(ModItems.FLUXSTALK),
                        item(ModItems.PLASMA_BERRY), item(ModItems.CONCENTRATED_PLASMA_JUICE_BUCKET),
                        item(ModItems.ENERGY_CRYSTAL), item(ModItems.CRYSTAL_INGOT),
                        item(ModItems.EMPTY_BAG), item(ModItems.FERTILIZER_FAST_GROWTH),
                        item(ModItems.FERTILIZER_FERTILE_SOIL), item(ModItems.STRANGE_FERTILIZER),
                        item(ModItems.COMET_SOIL), item(ModItems.COMET_SAPLING), item(ModItems.COMET_FRUIT),
                        item(ModItems.COMET_LEAVES),
                        item(ModItems.COMET_LOG), item(ModItems.COMET_WOOD),
                        item(ModItems.STRIPPED_COMET_LOG), item(ModItems.STRIPPED_COMET_WOOD),
                        item(ModItems.COMET_PLANKS), item(ModItems.COMET_STAIRS), item(ModItems.COMET_SLAB),
                        item(ModItems.COMET_FENCE), item(ModItems.COMET_FENCE_GATE), item(ModItems.COMET_DOOR),
                        item(ModItems.COMET_TRAPDOOR), item(ModItems.COMET_PRESSURE_PLATE),
                        item(ModItems.COMET_BUTTON), item(ModItems.COMET_SIGN), item(ModItems.COMET_HANGING_SIGN),
                        ...
                        item(ModItems.ADVANCED_OUTPUT_PIPE), item(ModItems.PIPE_SORTER), item(ModItems.GOLD_FLUID_PIPE),
                        item(ModItems.GOLD_PLASMA_EXTRACTOR), item(ModItems.COPPER_FLUID_STORAGE_CABINET),
