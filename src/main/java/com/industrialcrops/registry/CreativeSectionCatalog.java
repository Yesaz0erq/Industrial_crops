    ...
    public static List<Section> combinedSections() {
        return List.of(
                section("itemGroup.industrialcrops.section.industrial_crops",
                        ...
                        // Crops and agricultural supplies.
                        ...
                        item(ModItems.MINING_UPGRADE_COMPONENT),
                        ...
                        item(ModItems.CRYSTAL_LOGISTICS),
                        item(ModItems.TERRAIN_PROCESSOR),
                        item(ModItems.ANIMAL_BREEDER),
                        item(ModItems.CRAFTING_PROCESSOR),
                ...
                section("itemGroup.carrote_curios.section",
                        ...
                        item(CarroteCuriosItems.UNBREAKABLE),
                        item(CarroteCuriosItems.RESISTANCE),
