...
public final class TerrainProcessorScreen extends UpgradeableMachineScreen<TerrainProcessorMenu> {
    ...
    private void send(int action){
        try{
            ...
            PacketDistributor.sendToServer(new TerrainConfigPayload(menu.containerId,cx,cz,y1,y2,fill,replaceOnly,action));error=false;
    ...
    @Override public void render(GuiGraphics g,int mx,int my,float partial){
        renderBackground(g,mx,my,partial);super.render(g,mx,my,partial);renderTooltip(g,mx,my);renderUpgradeTab(g,mx,my);
