...
public final class TerrainProcessorBlock extends BaseEntityBlock {
    public static final MapCodec<TerrainProcessorBlock> CODEC = simpleCodec(TerrainProcessorBlock::new);
    ...
    @Override protected InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hit) {
        if (!level.isClientSide && player instanceof net.minecraft.server.level.ServerPlayer serverPlayer
                && level.getBlockEntity(pos) instanceof TerrainProcessorBlockEntity machine) serverPlayer.openMenu(machine, pos);
