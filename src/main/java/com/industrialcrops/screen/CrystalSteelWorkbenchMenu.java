...
public final class CrystalSteelWorkbenchMenu extends AbstractContainerMenu {
    ...
    public CrystalSteelWorkbenchMenu(int id, Inventory inventory, FriendlyByteBuf buffer) {
    ...
    @Override public void slotsChanged(Container container) {
        ...
        CraftingContainer input = inputs;
        ...
        if (custom != null) {
            ...
            ItemStack assembled = recipe.get().assemble(input, player.level().registryAccess());
