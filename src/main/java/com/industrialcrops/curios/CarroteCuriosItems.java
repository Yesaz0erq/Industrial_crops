...
public final class CarroteCuriosItems {
    ...
    public static final DeferredItem<Item> POWER = register("power_carrote");
    ...
    public static final DeferredItem<Item> BLAST = register("blast_carrote");
    public static final DeferredItem<Item> FALL = register("fall_carrote");
