...
public final class ManipulatorRecipes {
    ...
    public static ManipulatorRecipeDisplay advancedIndustrialStorage() {
        return new ManipulatorRecipeDisplay(List.of(
                ManipulatorIngredient.ofItem(ModBlocks.REINFORCED_CONTROL_DEVICE.asItem(), 1),
                ManipulatorIngredient.ofItem(ModBlocks.COPPER_FLUID_STORAGE_CABINET.asItem(), 4),
                ManipulatorIngredient.ofItem(com.industrialcrops.registry.ModItems.COMPONENT_SUBSTRATE.get(), 2)),
                new ItemStack(ModBlocks.ADVANCED_INDUSTRIAL_STORAGE_DEVICE.asItem()));
    }

    public static ManipulatorRecipeDisplay goldFluidPipe() {
        return new ManipulatorRecipeDisplay(List.of(
                ManipulatorIngredient.ofItem(Items.GOLD_NUGGET, 8),
                ManipulatorIngredient.ofItem(ModBlocks.PIPE.asItem(), 1),
                ManipulatorIngredient.ofItem(ModBlocks.COPPER_FLUID_STORAGE_CABINET.asItem(), 1)),
                new ItemStack(ModBlocks.GOLD_FLUID_PIPE.asItem(), 8));
    }
