...
public final class AdvancedIndustrialStorageMenu extends AbstractContainerMenu {
    ...
    public net.minecraftforge.fluids.FluidStack getStoredFluid() {
        ...
        return fluid == null || fluid == net.minecraft.world.level.material.Fluids.EMPTY || syncedFluidAmount == 0
                ? net.minecraftforge.fluids.FluidStack.EMPTY : new net.minecraftforge.fluids.FluidStack(fluid,syncedFluidAmount);
    }
