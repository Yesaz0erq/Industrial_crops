...
public final class AnimalBreederMenu extends AbstractContainerMenu {
    ...
    public AnimalBreederMenu(int id,Inventory inv,FriendlyByteBuf buf){this(id,inv,(AnimalBreederBlockEntity)inv.player.level().getBlockEntity(buf.readBlockPos()));}
