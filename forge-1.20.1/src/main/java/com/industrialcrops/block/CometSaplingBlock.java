...
public final class CometSaplingBlock extends SaplingBlock {
    public CometSaplingBlock(AbstractTreeGrower treeGrower, BlockBehaviour.Properties properties) {
    ...
    public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
        ...
        if (random.nextInt(5) == 0) {
            level.addParticle(ParticleTypes.END_ROD, x, y + 0.05D, z, 0.0D, 0.006D, 0.0D);
        }
    }
}
