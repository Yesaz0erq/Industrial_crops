...
public final class AdvancedIndustrialStorageScreen extends IndustrialContainerScreen<AdvancedIndustrialStorageMenu> {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (menu.hasFluidStorage()) {
            ...
            int color=fluid.isEmpty()?0xff4c9ed0:net.minecraftforge.client.extensions.common.IClientFluidTypeExtensions.of(fluid.getFluid()).getTintColor(fluid);
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (menu.hasFluidStorage() && mouseX>=leftPos+195 && mouseX<leftPos+219 && mouseY>=topPos+19 && mouseY<topPos+99) {
            ...
            graphics.renderComponentTooltip(font,java.util.List.of(
                    fluid.isEmpty()?Component.translatable("gui.industrialcrops.empty_tank"):fluid.getDisplayName(),
