...
public final class CrystalLogisticsScreen extends IndustrialContainerScreen<CrystalLogisticsMenu> {
    ...
    private void save() { com.industrialcrops.network.ModNetworking.sendToServer(new LogisticsConfigPayload(menu.containerId,channel.getValue(),output)); channel.setFocused(false); }
    ...
    @Override public void render(GuiGraphics g,int mx,int my,float partial) {
        ...
        if(mx>=leftPos+194&&mx<leftPos+220&&my>=topPos+78&&my<topPos+142) {
            ...
            g.renderComponentTooltip(font,List.of(fluid.isEmpty()?Component.translatable("gui.industrialcrops.empty_tank"):fluid.getDisplayName(),Component.literal(fluid.getAmount()+" / 16000 mB")),mx,my);
        }
